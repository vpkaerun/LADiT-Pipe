...
def setup_walking_test_files():
    ...
    speaker_a = Sine(440).to_audio_segment(duration=2000).set_channels(1).set_frame_rate(16000)
    speaker_b = Sine(660).to_audio_segment(duration=2000).set_channels(1).set_frame_rate(16000)
...
def test_walking_pipeline_e2e(setup_walking_test_files, output_dir):
    ...
    expected_output_files_30 = [
        output_dir / "walking_log_2025-08-30.txt",
        output_dir / "walking_log_2025-08-30.csv",
        output_dir / "walking_log_2025-08-30.json",
        output_dir / "walking_log_2025-08-30.srt",
        output_dir / "walking_log_2025-08-30.vtt",
    ]
    expected_output_files_31 = [
        output_dir / "walking_log_2025-08-31.txt",
        output_dir / "walking_log_2025-08-31.csv",
        output_dir / "walking_log_2025-08-31.json",
        output_dir / "walking_log_2025-08-31.srt",
        output_dir / "walking_log_2025-08-31.vtt",
    ]
    ...
    csv_file_30 = output_dir / "walking_log_2025-08-30.csv"
    ...
    csv_file_31 = output_dir / "walking_log_2025-08-31.csv"
